...
const ChildCareWhen = ({ navigation }) => {
    const [value, setValue] = React.useState('first')
    return (
        <View style={{ flex: 1 }}>
            <Header title="Need" navigation={navigation} />
            <View style={mystyle.container}>
                <View style={[mystyle.mv10, mystyle.mh5]}>
                    <Text style={[styles.headTxt]}>When do you need care ?</Text>
                </View>
                ...
                <View style={mystyle.nxtBtn}>
                    <Button mode="contained" color="#3cb371"
                        ...
                        onPress={() => navigation.navigate('KidsLove')}
                    >
                        <Text>Next</Text>
                    </Button>
                </View>
